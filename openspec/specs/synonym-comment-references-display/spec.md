# synonym-comment-references-display

Rendering of cited references on comments nested within OTU synonyms, in both the web and PDF presentations of OTU direct-query results.
